...
exports.transform = function (source, transform, options) {
    ...
    if (Array.isArray(source) && Array.isArray(transform)) {
        const result = {};

        transform.forEach((key, index) => {

            result[key] = source[index];
        });
        return result;
    }
...
exports.promiseWrap = function (bind, method, args, transform) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const callback = function (error, result) {
            ...
            if (Array.isArray(transform)) {
                result = exports.transform(Array.from(arguments), transform);
                error instanceof Error ? reject(result) : resolve(result);
            }
            else {
                error instanceof Error ? reject(error) : resolve(error || result);
            }
        };
