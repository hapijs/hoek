...
internals.seenProp = "_hoekseen"; // FYI checking for circ references is not thread safe
...
exports.clone = function (obj) {
    ...
    for (var i in obj) {
        if (obj.hasOwnProperty(i)) {
            if (obj[i].hasOwnProperty(internals.seenProp)) {
                throw "Circular reference found in Hoek.clone input for key " + i;
            }
            ...
            if (obj[i] instanceof Date) {
                ...
                if (typeof obj[i] == 'object') {
                    Object.defineProperty(obj[i], internals.seenProp, {
                        __proto__: null,
                        enumerable: false,
                        configurable: true,
                        value: true
    ...
    exports.expunge(internals.seenProp, obj); // remove all traces seenProp

    return newObj;
};


exports.expunge = function (key, obj) {
