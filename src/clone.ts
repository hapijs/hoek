...
const needsProtoHack = new Set([prototypes.set, prototypes.map, prototypes.weakSet, prototypes.weakMap]);
...
const base = function <T>(obj: T, baseProto: any, options: CloneOptions): T {
    if (options.prototype === false) {
        // Defaults to true
        if (needsProtoHack.has(baseProto)) {
